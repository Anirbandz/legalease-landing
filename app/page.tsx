                ...
                <div className="hidden md:flex items-center space-x-8">
                  ...
                  {user ? (
                    <div className="flex items-center space-x-3">
                      <Image src={user.avatar_url || '/placeholder-user.jpg'} alt={user.user_metadata?.username ? `${user.user_metadata.username} avatar` : 'avatar'} width={32} height={32} style={{ borderRadius: '50%' }} />
